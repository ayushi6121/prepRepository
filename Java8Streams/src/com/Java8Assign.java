...
public class Java8Assign {

	public static void main(String[] args) {
		List<Employee> employees = new ArrayList<Employee>();
		employees.add(new Employee("A", "Z", "HR", 2023, 6000, "1982-10-12"));
		employees.add(new Employee("B", "Y", "IT", 2022, 7000, "1990-11-29"));
		employees.add(new Employee("C", "X", "HR", 2023, 5000, "1995-01-26"));
		employees.add(new Employee("D", "W", "IT", 2021, 8000, "1978-03-24"));
		employees.add(new Employee("E", "V", "FINANCE", 2021, 9000, "1962-04-31"));
